...
if __name__ == '__main__':
    ...
    clf = pipeline.Pipeline([('svd', svd),('svm', svm_model)])
    
    # Create a parameter grid to search for best parameters for everything in the pipeline
    param_grid = {'svd__n_components' : [200, 400, 800],
                  'svm__C': [.1,1,10,16,25]} 
    param_grid={'svd__n_components' : [ 400],'svm__n_estimators':[100],'svm__learning_rate':[.1]}
